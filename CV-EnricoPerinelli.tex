...
\item Balducci, C., \textbf{Perinelli, E.}, Avanzi, L., Atroszko, P., Charzyńska, E., \& Menghini, L. (in press). Does your work make you a workaholic? Situational triggers and chronic enhancers of state workaholism. \textit{Work \& Stress}.

\item Giovanelli, E., \textbf{Perinelli, E.}, Valzolgher, C., Gessa, E., \& Pavani, F. (in press). Self-Efficacy and Locus of Control when facing listening challenges: Validation of the Listening Challenges Attitude Scale (LiCAS). \textit{International Journal of Listening}.
...
\item Zagaria, A., \textbf{Perinelli, E.}, \& Lombardi, L. (2025). \textit{The structure of Attachment Trauma: a Confirmatory Factor Analysis and Latent Profile Analysis on the Adult Attachment Trauma Questionnaire}. Manuscript submitted for publication.
...
\item {\textbf{\large{Ad-hoc Reviewer}}}\\
	...
	\textit{Journal of Business and Psychology} (2 in 2022, 2 in 2023, 2 in 2024, 1 in 2025) \\
