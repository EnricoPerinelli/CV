...
\vspace{1em}
Data Wrangling and Cleaning (e.g., \texttt{tidyverse}), PRISMA Criteria, Meta-analyses (\texttt{metafor}), Multivariate Statistics, Structural Equation Modeling (SEM), Longitudinal SEM, Multilevel SEM, Mediation and Moderation, Mixture Modeling, Machine Learning (basic).
