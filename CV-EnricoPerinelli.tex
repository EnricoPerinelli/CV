...
\item Neoh, M. J. Y., Lieu, A. A., \textbf{Perinelli, E.}, Balagtas, J. P. M., Nah, H., Ho, M.-H. R., \& Esposito, G. (in press). An intergenerational study of parental bonding on perceptions of parental and spousal criticism and marital relationship quality in Singapore. \textit{Family Process}. \url{https://doi.org/10.1111/famp.12942}

\item Alessandri, G., Tavolucci, S., \textbf{Perinelli, E.}, Eisenberg, N., Golfieri, F., Caprara, G. V., \& Crocetti, E. (2023). Regulatory emotional self-efficacy beliefs matter for (mal)adjustment: A meta-analysis. \textit{Current Psychology, 42}(35), 31004–31023. \url{https://doi.org/10.1007/s12144-022-04099-3}

\item \textbf{Perinelli, E.}, Vignoli, M., Kröner, F., Müller, A., Genrich, M., \& Fraccaroli, F. (2023). Workers' emotional exhaustion and mental well-being over the COVID-19 pandemic: A Dynamic Structural Equation Modeling (DSEM) approach. \textit{Frontiers in Psychology, 14}, Article 1222845. \url{https://doi.org/10.3389/fpsyg.2023.1222845}

\item \textbf{Perinelli, E.}, Balducci, C., \& Fraccaroli, F. (2023). Structural validity and classification performance of the Italian Short Negative Acts Questionnaire: A Structural Equation Modeling approach for building ROC curves. \textit{Current Psychology, 42}(30), 26300-26316. \url{https://doi.org/10.1007/s12144-022-03741-4}

\item Avanzi, L., \textbf{Perinelli, E.}, \& Mariani, M. G. (2023). The effect of individual, group, and shared organizational identification on job satisfaction and collective actual turnover. \textit{European Journal of Social Psychology, 53}(5), 956-969. \url{https://doi.org/10.1002/ejsp.2946}
...
\begin{itemize}
	...
	\item {\textbf{\large{Manuscripts submitted for publication or in preparation}}}
\end{itemize}
\begin{etaremune}

	\item \textbf{Perinelli, E.}, Stella, M., Bizzego, A., Pisanu, F., \& Fraccaroli, F. (2023). \textit{Lagged predictors of Psychological Capital in junior high school students: A supervised Machine Learning approach}. Manuscript in preparation.

	\item Stanghellini, F., \textbf{Perinelli, E.}, Lombardi, L., \& Stella, M. (2023). \textit{Introducing semantic loadings: Bridging cognitive network science with network psychometrics for understanding depression, anxiety and stress}. Manuscript submitted for publication.
...
\begin{itemize} 
	...
	\textit{Journal of Business and Psychology} (2 in 2022, 2 in 2023) \\
